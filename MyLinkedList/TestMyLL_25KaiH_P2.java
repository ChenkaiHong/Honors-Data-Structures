 ...
 * @version 10/24/2023
 */
public class TestMyLL_25KaiH_P2 {
    ...
    public static void main(String[] args) {
        ...
        MyList<Integer> nums1 = new MyLinkedList<Integer>();
        /**
         ...
         * toString 
         */
        MyList<Integer> nums2 = new MyLinkedList<Integer>();
        boolean test2 = true;
        if (!test2) {
        ...
        if (!test3) {
            ...
            /* */
            MyIterator iterator1 = nums2.iterator();
         ...
         *
         ...
         System.out.println("\n More tests:");
         throw new RuntimeException("Write code to test MyLinkedList");
         }
         */
         ...
         * add, remove, set, get
         * Tests when underlying linked list does have such and index and when it does not.
         */
        boolean test6 = true;
        if (!test6) {
        ...
        {
            System.out.println("Testing additional LinkedList methods:");
